bot = dofile('/home/kiava/cli/data/utils.lua')
json = dofile('/home/kiava/cli/data/JSON.lua')
...
BASE = '/home/kiava/cli/bot/'
day = 86400
SUDO = 247134702 --sudo id
sudo_users = {247134702,387388679,366848429,334984718,userid}
BOTS = 387388679 --bot id
bot_id = 387388679
...
function is_bot(msg)
  if tonumber(BOTS) == 387388679 then
    return true
    else
    return false
    end
